...
=end    
    ...
    config.vm.define "main-server" do |h|
        ...
        h.vm.network "private_network", ip: "172.16.1.50"
    ...
    config.vm.define "server-a" do |h|
        ...
        h.vm.network "private_network", ip: "172.16.1.51"
        h.vm.provision "shell", path: "provisioning.sh"
        h.vm.provider "virtualbox" do |vb|
    ...
    config.vm.define "server-b" do |h|
        ...
        h.vm.network "private_network", ip: "172.16.1.52"
        h.vm.provision "shell", path: "provisioning.sh"
        h.vm.provider "virtualbox" do |vb|
    ...
    config.vm.define "server-c" do |h|
        ...
        h.vm.network "private_network", ip: "172.16.1.53"
        h.vm.provision "shell", path: "provisioning.sh"
        h.vm.provider "virtualbox" do |vb|
